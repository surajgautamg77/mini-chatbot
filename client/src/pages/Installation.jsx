...
import { Copy, Check, Code, ExternalLink, FileText, ClipboardCopy, Layout, AlertCircle } from 'lucide-react';
  ...
  if (!selectedChatbot) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center p-6 bg-white">
        ...
        <p className="text-gray-500 mt-2">Select a chatbot to get its integration script.</p>
      </div>
    );
  }
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      <div className="mb-10 text-center md:text-left">
        ...
        <p className="text-gray-600 text-lg">A simple one-line script to add AI to your site.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
          ...
          <p className="text-sm text-gray-500">Ensure your chatbot has documents uploaded in the Knowledge Base.</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
          ...
          <p className="text-sm text-gray-500">Copy the unique script tag generated for <b>{selectedChatbot.name}</b>.</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
          ...
          <p className="text-sm text-gray-500">Paste it anywhere in your site HTML (usually before <code>&lt;/body&gt;</code>).</p>
        </div>
      </div>
      ...
      <div className="card p-8 bg-white border border-gray-100 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-xl font-bold text-gray-900">Integration Script</h2>
          </div>
        ...
        <div className="mt-8 flex items-center justify-between p-5 bg-blue-50 rounded-2xl border border-blue-100">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-sm text-blue-900 font-bold">Local Development Note</p>
              <p className="text-xs text-blue-700">Ensure both backend (8000) and frontend (5173) are running for the widget to work locally.</p>
            </div>
          </div>
          <a 
